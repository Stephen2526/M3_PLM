...
class ResiduePosition:
  chain_id: str # auth_chain_id
  residue_number: int # auth_resi_num
  insertion_code: str
...
class MmcifObject:
  ...
  raw_string: Any
  mmcif_to_auth_cid: Mapping[str, str]
...
def parse(*,
  ...
  try:
    ...
    mmcif_object = MmcifObject(
        ...
        mmcif_to_auth_cid=mmcif_to_author_chain_id)
...
def _get_protein_chains(
  ...
  for struct_asym in struct_asyms:
    chain_id = struct_asym['_struct_asym.id'] # re-defined chain id (not auth)
